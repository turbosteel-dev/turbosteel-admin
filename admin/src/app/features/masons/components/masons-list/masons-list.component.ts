...
@Component({
  selector: 'app-masons-list',
  templateUrl: './masons-list.component.html',
  styleUrls: ['./masons-list.component.scss']
})
export class MasonsListComponent {
  banner: any[] = [];
  bannerUrl = '/api/mansons'
