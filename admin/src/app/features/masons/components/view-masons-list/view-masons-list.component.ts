...
@Component({
  selector: 'app-view-masons-list',
  templateUrl: './view-masons-list.component.html',
  styleUrls: ['./view-masons-list.component.scss']
})
export class ViewMasonsListComponent {
  companyListUrl = '/api/mansons';
  companyListData: any;
