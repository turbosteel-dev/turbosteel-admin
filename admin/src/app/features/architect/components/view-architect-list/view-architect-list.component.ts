...
@Component({
  selector: 'app-view-architect-list',
  templateUrl: './view-architect-list.component.html',
  styleUrls: ['./view-architect-list.component.scss']
})
export class ViewArchitectListComponent {
companyListUrl = '/api/architects';
  companyListData: any;
