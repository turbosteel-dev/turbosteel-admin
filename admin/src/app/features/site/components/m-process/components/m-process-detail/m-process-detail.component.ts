...
@Component({
  selector: 'app-m-process-detail',
  templateUrl: './m-process-detail.component.html',
  styleUrls: ['./m-process-detail.component.scss']
})
export class MProcessDetailComponent {
corporate: any[] = [];
  corporateUrl = '/api/manufacture/manufactureDetail';
