...
@Component({
  selector: 'app-new-m-process-banner',
  templateUrl: './new-m-process-banner.component.html',
  styleUrls: ['./new-m-process-banner.component.scss']
})
export class NewMProcessBannerComponent {
bannerForm!: FormGroup;
  bannerUrl = '/api/manufacture/manufactureBanner';
  isEdit = false;
  responseData: any;
  bannerData: any;
  bannerUpdatedUrl = '';
    ...
    if (this.isEdit == false) {
      if (this.bannerForm.valid) {
        ...
        this.httpService.post(this.bannerUrl, formData).subscribe(response => {
          ...
          this.router.navigate(['/site/manufacture-process/mprocess-banner']);
        },
