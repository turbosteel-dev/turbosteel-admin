...
@Component({
  selector: 'app-new-about-header',
  templateUrl: './new-about-header.component.html',
  styleUrls: ['./new-about-header.component.scss']
})
export class NewAboutHeaderComponent {
 bannerForm!: FormGroup;
    bannerUrl = '/api/header/aboutHeader';
    isEdit = false;
    responseData: any;
    bannerData: any;
    bannerUpdatedUrl = '';
      ...
      if (this.isEdit == false) {
        if (this.bannerForm.valid) {
          this.httpService.post(this.bannerUrl, this.bannerForm.getRawValue()).subscribe(response => {
            ...
            this.router.navigate(['/site/header/about-header']);
          },
