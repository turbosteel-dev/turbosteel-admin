...
@Component({
  selector: 'app-new-vision-banner',
  templateUrl: './new-vision-banner.component.html',
  styleUrls: ['./new-vision-banner.component.scss']
})
export class NewVisionBannerComponent {
