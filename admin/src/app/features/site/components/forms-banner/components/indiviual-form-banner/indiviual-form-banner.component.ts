...
@Component({
  selector: 'app-indiviual-form-banner',
  templateUrl: './indiviual-form-banner.component.html',
  styleUrls: ['./indiviual-form-banner.component.scss']
})
export class IndiviualFormBannerComponent {
banner: any[] = [];
