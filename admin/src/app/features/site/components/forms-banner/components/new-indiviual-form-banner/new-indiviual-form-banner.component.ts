...
@Component({
  selector: 'app-new-indiviual-form-banner',
  templateUrl: './new-indiviual-form-banner.component.html',
  styleUrls: ['./new-indiviual-form-banner.component.scss']
})
export class NewIndiviualFormBannerComponent {
 bannerForm!: FormGroup;
  bannerUrl = '/api/forms/inHouseFormBanner'
  isEdit = false;
  responseData: any;
  bannerData: any;
  bannerUpdatedUrl = '';
    ...
    if (this.isEdit == false) {
      if (this.bannerForm.valid) {
        ...
        this.httpService.post(this.bannerUrl, formData).subscribe(response => {
          ...
          this.router.navigate(['/site/forms/indiviual-form-banner']);
        },
