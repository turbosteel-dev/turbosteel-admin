...
@Component({
  selector: 'app-new-dealership',
  templateUrl: './new-dealership.component.html',
  styleUrls: ['./new-dealership.component.scss']
})
export class NewDealershipComponent {
 bannerForm!: FormGroup;
  bannerUrl = '/api/forms/delearShipBanner'
  isEdit = false;
  responseData: any;
  bannerData: any;
  bannerUpdatedUrl = '';
    ...
    if (this.isEdit == false) {
      if (this.bannerForm.valid) {
        ...
        this.httpService.post(this.bannerUrl, formData).subscribe(response => {
          ...
          this.router.navigate(['/site/forms/dealership-banner']);
        },
