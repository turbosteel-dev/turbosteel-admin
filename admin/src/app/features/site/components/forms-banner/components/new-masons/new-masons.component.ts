...
@Component({
  selector: 'app-new-masons',
  templateUrl: './new-masons.component.html',
  styleUrls: ['./new-masons.component.scss']
})
export class NewMasonsComponent {
bannerForm!: FormGroup;
  bannerUrl = '/api/forms/masonsBanner'
  isEdit = false;
  responseData: any;
  bannerData: any;
  bannerUpdatedUrl = '';
    ...
    if (this.isEdit == false) {
      if (this.bannerForm.valid) {
        ...
        this.httpService.post(this.bannerUrl, formData).subscribe(response => {
          ...
          this.router.navigate(['/site/forms/masons-banner']);
        },
