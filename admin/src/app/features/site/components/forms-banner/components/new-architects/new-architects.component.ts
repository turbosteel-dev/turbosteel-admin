...
@Component({
  selector: 'app-new-architects',
  templateUrl: './new-architects.component.html',
  styleUrls: ['./new-architects.component.scss']
})
export class NewArchitectsComponent {
  bannerForm!: FormGroup;
  bannerUrl = '/api/forms/architectBanner'
  isEdit = false;
  responseData: any;
  bannerData: any;
  bannerUpdatedUrl = '';
    ...
    if (this.isEdit == false) {
      if (this.bannerForm.valid) {
        ...
        this.httpService.post(this.bannerUrl, formData).subscribe(response => {
          ...
          this.router.navigate(['/site/forms/architects-banner']);
        },
