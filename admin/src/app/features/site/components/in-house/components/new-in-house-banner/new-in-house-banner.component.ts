...
@Component({
  selector: 'app-new-in-house-banner',
  templateUrl: './new-in-house-banner.component.html',
  styleUrls: ['./new-in-house-banner.component.scss']
})
export class NewInHouseBannerComponent {
bannerForm!: FormGroup;
  bannerUrl = '/api/inHouse/InHouseBanner';
  isEdit = false;
  responseData: any;
  bannerData: any;
  bannerUpdatedUrl = '';
    ...
    if (this.isEdit == false) {
      if (this.bannerForm.valid) {
        ...
        this.httpService.post(this.bannerUrl, formData).subscribe(response => {
          ...
          this.router.navigate(['/site/inhouse/inhouse-banner']);
        },
