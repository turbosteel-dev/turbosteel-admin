...
@Component({
  selector: 'app-new-career-banner',
  templateUrl: './new-career-banner.component.html',
  styleUrls: ['./new-career-banner.component.scss']
})
export class NewCareerBannerComponent {
    ...
    if (this.isEdit == false) {
      if (this.bannerForm.valid) {
        ...
        this.httpService.post(this.bannerUrl, formData).subscribe(response => {
          ...
          this.router.navigate(['/site/career/career-banner']);
        },
