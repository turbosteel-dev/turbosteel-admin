...
@Component({
  selector: 'app-facilities-category',
  templateUrl: './facilities-category.component.html',
  styleUrls: ['./facilities-category.component.scss']
})
export class FacilitiesCategoryComponent {
banner: any[] = [];
