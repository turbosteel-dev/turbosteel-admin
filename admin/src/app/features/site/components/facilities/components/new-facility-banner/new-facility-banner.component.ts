...
@Component({
  selector: 'app-new-facility-banner',
  templateUrl: './new-facility-banner.component.html',
  styleUrls: ['./new-facility-banner.component.scss']
})
export class NewFacilityBannerComponent {
  bannerForm!: FormGroup;
  bannerUrl = '/api/facilities/facilitiesBanner';
  isEdit = false;
  responseData: any;
  bannerData: any;
  bannerUpdatedUrl = '';
  ...
  preFormData() {
    this.bannerForm.patchValue({
      facilities_url: this.bannerData.facilities_url,
  ...
  onSubmit() {
    if (this.isEdit == false) {
      if (this.bannerForm.valid) {
        ...
        formData.append('facilities_url', this.bannerForm.get('facilities_url')?.value);
        ...
        this.httpService.post(this.bannerUrl, formData).subscribe(response => {
          ...
          this.router.navigate(['/site/facilities/facilities-banner']);
        },
