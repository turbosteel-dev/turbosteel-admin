...
@Component({
  selector: 'app-new-contact-banner',
  templateUrl: './new-contact-banner.component.html',
  styleUrls: ['./new-contact-banner.component.scss']
})
export class NewContactBannerComponent {
    ...
    if (this.isEdit == false) {
      if (this.bannerForm.valid) {
        ...
        this.httpService.post(this.bannerUrl, formData).subscribe(response => {
          ...
          this.router.navigate(['/site/contact/contact-banner']);
        },
