...
@Component({
  selector: 'app-new-chairman-banner',
  templateUrl: './new-chairman-banner.component.html',
  styleUrls: ['./new-chairman-banner.component.scss']
})
export class NewChairmanBannerComponent {
    ...
    if (this.isEdit == false) {
      if (this.bannerForm.valid) {
        ...
        this.httpService.post(this.bannerUrl, formData).subscribe(response => {
          ...
          this.router.navigate(['/site/chairman/chairman-banner']);
        },
