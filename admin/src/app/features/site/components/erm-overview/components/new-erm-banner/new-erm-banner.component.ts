...
@Component({
  selector: 'app-new-erm-banner',
  templateUrl: './new-erm-banner.component.html',
  styleUrls: ['./new-erm-banner.component.scss']
})
export class NewErmBannerComponent {
bannerForm!: FormGroup;
  bannerUrl = '/api/erm/ermBanner';
  isEdit = false;
  responseData: any;
  bannerData: any;
  bannerUpdatedUrl = '';
    ...
    if (this.isEdit == false) {
      if (this.bannerForm.valid) {
        ...
        this.httpService.post(this.bannerUrl, formData).subscribe(response => {
          ...
          this.router.navigate(['/site/erm/erm-banner']);
        },
