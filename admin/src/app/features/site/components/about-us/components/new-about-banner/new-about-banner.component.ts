...
@Component({
  selector: 'app-new-about-banner',
  templateUrl: './new-about-banner.component.html',
  styleUrls: ['./new-about-banner.component.scss']
})
export class NewAboutBannerComponent {
    ...
    if (this.isEdit == false) {
      if (this.bannerForm.valid) {
        ...
        this.httpService.post(this.bannerUrl, formData).subscribe(response => {
          ...
          this.router.navigate(['/site/about/about-banner']);
        },
