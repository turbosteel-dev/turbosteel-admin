...
@Component({
  selector: 'app-new-about-list',
  templateUrl: './new-about-list.component.html',
  styleUrls: ['./new-about-list.component.scss']
})
export class NewAboutListComponent {
bannerForm!: FormGroup;
  bannerUrl = '/api/about/aboutNumberList';
  isEdit = false;
  responseData: any;
  bannerData: any;
  bannerUpdatedUrl = '';
    ...
    if (this.isEdit == false) {
      if (this.bannerForm.valid) {
        this.httpService.post(this.bannerUrl, this.bannerForm.getRawValue()).subscribe(response => {
          ...
          this.router.navigate(['/site/about/about-list']);
        },
