...
@Component({
  selector: 'app-new-about-galler',
  templateUrl: './new-about-galler.component.html',
  styleUrls: ['./new-about-galler.component.scss']
})
export class NewAboutGallerComponent {
bannerForm!: FormGroup;
  bannerUrl = '/api/about/aboutUsGallery';
  isEdit = false;
  responseData: any;
  bannerData: any;
  bannerUpdatedUrl = '';
    ...
    if (this.isEdit == false) {
      if (this.bannerForm.valid) {
        ...
        this.httpService.post(this.bannerUrl, formData).subscribe(response => {
          ...
          this.router.navigate(['/site/about/about-gallery']);
        },
