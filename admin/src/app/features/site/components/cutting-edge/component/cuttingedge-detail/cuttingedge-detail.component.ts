...
@Component({
  selector: 'app-cuttingedge-detail',
  templateUrl: './cuttingedge-detail.component.html',
  styleUrls: ['./cuttingedge-detail.component.scss']
})
export class CuttingedgeDetailComponent {
corporate: any[] = [];
  corporateUrl = '/api/cuttingEdge/cuttingEdgeDetail';
