...
@Component({
  selector: 'app-new-cuttingedge-banner',
  templateUrl: './new-cuttingedge-banner.component.html',
  styleUrls: ['./new-cuttingedge-banner.component.scss']
})
export class NewCuttingedgeBannerComponent {
bannerForm!: FormGroup;
  bannerUrl = '/api/cuttingEdge/cuttingEdgeBanner';
  isEdit = false;
  responseData: any;
  bannerData: any;
  bannerUpdatedUrl = '';
    ...
    if (this.isEdit == false) {
      if (this.bannerForm.valid) {
        ...
        this.httpService.post(this.bannerUrl, formData).subscribe(response => {
          ...
          this.router.navigate(['/site/cuttingedge/cuttingedge-banner']);
        },
