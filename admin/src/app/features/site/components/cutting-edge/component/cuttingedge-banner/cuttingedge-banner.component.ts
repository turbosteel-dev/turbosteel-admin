...
@Component({
  selector: 'app-cuttingedge-banner',
  templateUrl: './cuttingedge-banner.component.html',
  styleUrls: ['./cuttingedge-banner.component.scss']
})
export class CuttingedgeBannerComponent {
banner: any[] = [];
