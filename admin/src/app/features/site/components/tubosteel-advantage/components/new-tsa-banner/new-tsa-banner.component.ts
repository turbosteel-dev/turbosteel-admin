...
@Component({
  selector: 'app-new-tsa-banner',
  templateUrl: './new-tsa-banner.component.html',
  styleUrls: ['./new-tsa-banner.component.scss']
})
export class NewTsaBannerComponent {
  bannerForm!: FormGroup;
  bannerUrl = '/api/turboSteel/turboSteelBanner';
  isEdit = false;
  responseData: any;
  bannerData: any;
  bannerUpdatedUrl = '';
    ...
    if (this.isEdit == false) {
      if (this.bannerForm.valid) {
        ...
        this.httpService.post(this.bannerUrl, formData).subscribe(response => {
          ...
          this.router.navigate(['/site/turbosteel-advantage/turbosteel-banner']);
        },
