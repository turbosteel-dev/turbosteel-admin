...
@Component({
  selector: 'app-tsa-list',
  templateUrl: './tsa-list.component.html',
  styleUrls: ['./tsa-list.component.scss']
})
export class TsaListComponent {
corporate: any[] = [];
  corporateUrl = '/api/turboSteel/turboSteelList';;
