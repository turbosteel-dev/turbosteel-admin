...
@Component({
  selector: 'app-new-product-feature-banner',
  templateUrl: './new-product-feature-banner.component.html',
  styleUrls: ['./new-product-feature-banner.component.scss']
})
export class NewProductFeatureBannerComponent {
  bannerForm!: FormGroup;
  bannerUrl = '/api/productFeature/productFeatureBanner';
  isEdit = false;
  responseData: any;
  bannerData: any;
  bannerUpdatedUrl = '';
    ...
    if (this.isEdit == false) {
      if (this.bannerForm.valid) {
        ...
        this.httpService.post(this.bannerUrl, formData).subscribe(response => {
          ...
          this.router.navigate(['/site/product-feature/product-feature-banner']);
        },
