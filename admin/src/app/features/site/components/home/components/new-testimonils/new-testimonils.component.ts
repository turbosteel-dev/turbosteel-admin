...
@Component({
  selector: 'app-new-testimonils',
  templateUrl: './new-testimonils.component.html',
  styleUrls: ['./new-testimonils.component.scss']
})
export class NewTestimonilsComponent {
  bannerForm!: FormGroup;
  bannerUrl = '/api/home/testimonials';
  isEdit = false;
  responseData: any;
  bannerData: any;
  bannerUpdatedUrl = '';
    ...
    if (this.isEdit == false) {
      if (this.bannerForm.valid) {
        ...
        this.httpService.post(this.bannerUrl, formData).subscribe(response => {
          ...
          this.router.navigate(['/site/home/testimonials']);
        },
