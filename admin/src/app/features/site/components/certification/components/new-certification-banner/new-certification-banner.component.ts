...
@Component({
  selector: 'app-new-certification-banner',
  templateUrl: './new-certification-banner.component.html',
  styleUrls: ['./new-certification-banner.component.scss']
})
export class NewCertificationBannerComponent {
bannerForm!: FormGroup;
  bannerUrl = '/api/certification/certificationBanner';
  isEdit = false;
  responseData: any;
  bannerData: any;
  bannerUpdatedUrl = '';
    ...
    if (this.isEdit == false) {
      if (this.bannerForm.valid) {
        ...
        this.httpService.post(this.bannerUrl, formData).subscribe(response => {
          ...
          this.router.navigate(['/site/certification/certification-banner']);
        },
