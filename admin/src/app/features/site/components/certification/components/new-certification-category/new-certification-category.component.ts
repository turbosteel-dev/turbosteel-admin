...
@Component({
  selector: 'app-new-certification-category',
  templateUrl: './new-certification-category.component.html',
  styleUrls: ['./new-certification-category.component.scss']
})
export class NewCertificationCategoryComponent {
bannerForm!: FormGroup;
  bannerUrl = '/api/certification/certficartionCategory';
  isEdit = false;
  responseData: any;
  bannerData: any;
  bannerUpdatedUrl = '';
    ...
    if (this.isEdit == false) {
      if (this.bannerForm.valid) {
        this.httpService.post(this.bannerUrl, this.bannerForm.getRawValue()).subscribe(response => {
          ...
          this.router.navigate(['/site/certification/certification-category']);
        },
