...
@Component({
  selector: 'app-new-csr-banner',
  templateUrl: './new-csr-banner.component.html',
  styleUrls: ['./new-csr-banner.component.scss']
})
export class NewCsrBannerComponent {
bannerForm!: FormGroup;
  bannerUrl = '/api/csr/csrBanner';
  isEdit = false;
  responseData: any;
  bannerData: any;
  bannerUpdatedUrl = '';
    ...
    if (this.isEdit == false) {
      if (this.bannerForm.valid) {
        ...
        this.httpService.post(this.bannerUrl, formData).subscribe(response => {
          ...
          this.router.navigate(['/site/csr/csr-banner']);
        },
